        ...
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
                <div class="col-lg-7 mb-2">
                    ...
                    <form action="https://formsubmit.co/husnainabbasi743701@gmail.com" method="POST" >
                            <div class="row">
                                <div class="col-6 form-group">
                                    <input type="text" class="form-control p-4" name="name" placeholder="Your Name" required="required">
                                </div>
                                <div class="col-6 form-group">
                                <input type="hidden" name="_subject" value="New submission!" required="required">
                            ...
                            <div>
                                <button class="btn btn-primary py-3 px-5" name="send" type="submit">Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
